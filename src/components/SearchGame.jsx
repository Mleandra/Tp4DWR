    ...
    return (
        <form className="relative my-4">
            ...
            <div className="relative">
                ...
                <input type="text" id="search" className="block w-full p-4 pl-10 text-sm text-gray-900 rounded-lg border border-gray-300  bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Recherche..."
                    value={searchValue}
                    onChange={
